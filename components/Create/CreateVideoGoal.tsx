...
const CreateVideo = ({
  ...
  return (
    <React.Fragment>
            ...
            <div className="flex-1 flex flex-col justify-center items-center">
              ...
              <Form
                onSubmit={form.handleSubmit(async (data) => {
                  const body = {
                    composition:
                      orientation === 'portrait' ? 'Goal' : 'GoalSquare',
                    inputProps,
                  };
      ...
      {/* Secondary column */}
      <aside className="w-2/6 bg-white border-l border-gray-200">
        <div className="flex-1 flex flex-col justify-center items-center">
          <Player
            style={{
              display: 'block',
